...
public class Z_FloaterControl_02 : MonoBehaviour {
	...
	public float transMultY = 1;

	
	
	//external transforms
	public Transform tilt;
	public Transform sinFloater;
	public Transform floaterP;
	...
	void Update () {
		...
		sinFloater.transform.localPosition = new Vector3 (transform.position.x , sinTest, -transform.position.z);
		...
		floaterP.position = new Vector3 (0,Input.GetAxis ("FloatY")*transMultY,0);
